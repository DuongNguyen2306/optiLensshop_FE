...
function LogoMark() {
  return (
    <Link
      to="/"
      className="group flex min-w-0 shrink-0 items-center gap-3 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#2BBBAD]/50"
    >
      <span
