...
function buildTimeline(order: CustomerOrderListItem, pay: PayInfo | null): TStep[] {
  ...
  const paidDate = pay?.paid_at ?? findHistoryDate("deposit", "paid", "payment");
  ...
  return [
    ...
    { label: "Đã thanh toán cọc",             done: Boolean(paidDate),  active: !paidDate && s !== "pending", date: paidDate },
          ...
          <div className="space-y-2 text-sm">
            ...
            {remainingAmount != null && remainingAmount > 0 &&
              ...
              <div className="mt-3 flex items-center gap-2 rounded-xl border border-teal-200 bg-teal-50 px-4 py-3">
                ...
                <p className="text-sm font-semibold text-teal-700">Đã thanh toán đầy đủ — không cần thu thêm khi giao hàng.</p>
              </div>
            ) : null}
